...
class WindowClass(QMainWindow, form_class):
    ...
    def btnClick(self): 
        ...
        print(newlist)
        self.lbl_1.setText(str(newlist[0]))
        self.lbl_2.setText(str(newlist[1]))
        self.lbl_3.setText(str(newlist[2]))
        self.lbl_4.setText(str(newlist[3]))
        self.lbl_5.setText(str(newlist[4]))
        self.lbl_6.setText(str(newlist[5]))    
